...
C_SRCS += \
../Middlewares/wolfssl/wolfcrypt/test/test.c 

OBJS += \
./Middlewares/wolfssl/wolfcrypt/test/test.o 

C_DEPS += \
./Middlewares/wolfssl/wolfcrypt/test/test.d 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/wolfssl/wolfcrypt/test/%.o Middlewares/wolfssl/wolfcrypt/test/%.su Middlewares/wolfssl/wolfcrypt/test/%.cyclo: ../Middlewares/wolfssl/wolfcrypt/test/%.c Middlewares/wolfssl/wolfcrypt/test/subdir.mk
...
clean: clean-Middlewares-2f-wolfssl-2f-wolfcrypt-2f-test

clean-Middlewares-2f-wolfssl-2f-wolfcrypt-2f-test:
	-$(RM) ./Middlewares/wolfssl/wolfcrypt/test/test.cyclo ./Middlewares/wolfssl/wolfcrypt/test/test.d ./Middlewares/wolfssl/wolfcrypt/test/test.o ./Middlewares/wolfssl/wolfcrypt/test/test.su

.PHONY: clean-Middlewares-2f-wolfssl-2f-wolfcrypt-2f-test
