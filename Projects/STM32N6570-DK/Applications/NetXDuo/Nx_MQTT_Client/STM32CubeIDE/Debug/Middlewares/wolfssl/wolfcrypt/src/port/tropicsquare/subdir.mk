...
C_SRCS += \
../Middlewares/wolfssl/wolfcrypt/src/port/tropicsquare/tropic01.c 

OBJS += \
./Middlewares/wolfssl/wolfcrypt/src/port/tropicsquare/tropic01.o 

C_DEPS += \
./Middlewares/wolfssl/wolfcrypt/src/port/tropicsquare/tropic01.d 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/wolfssl/wolfcrypt/src/port/tropicsquare/%.o Middlewares/wolfssl/wolfcrypt/src/port/tropicsquare/%.su Middlewares/wolfssl/wolfcrypt/src/port/tropicsquare/%.cyclo: ../Middlewares/wolfssl/wolfcrypt/src/port/tropicsquare/%.c Middlewares/wolfssl/wolfcrypt/src/port/tropicsquare/subdir.mk
...
clean: clean-Middlewares-2f-wolfssl-2f-wolfcrypt-2f-src-2f-port-2f-tropicsquare

clean-Middlewares-2f-wolfssl-2f-wolfcrypt-2f-src-2f-port-2f-tropicsquare:
	-$(RM) ./Middlewares/wolfssl/wolfcrypt/src/port/tropicsquare/tropic01.cyclo ./Middlewares/wolfssl/wolfcrypt/src/port/tropicsquare/tropic01.d ./Middlewares/wolfssl/wolfcrypt/src/port/tropicsquare/tropic01.o ./Middlewares/wolfssl/wolfcrypt/src/port/tropicsquare/tropic01.su

.PHONY: clean-Middlewares-2f-wolfssl-2f-wolfcrypt-2f-src-2f-port-2f-tropicsquare
